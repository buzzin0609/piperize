...
const piperize_1 = require("./piperize");
...
describe('piperize:', function () {
    ...
    it('should return a function', function () {
        expect(typeof piperize_1.default(foo => foo * 2)).toEqual('function');
    });
    it('should call each provided function when invoking the pipeline callback', function () {
        const pipeline = piperize_1.default(spy1, spy2);
        pipeline(10);
    ...
    it('should call subsequent callbacks with the accumulated value', function () {
        ...
        const pipeline = piperize_1.default(spy1, spy2, spy3, spy4);
        pipeline(20);
    ...
    it('should throw an error if one of the functions doesnt return anything', function () {
        function badEgg() { }
        const pipeline = piperize_1.default(spy1, badEgg, spy2);
