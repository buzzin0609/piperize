	...
	it('should resolve to have an error property if function errors', function () {
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, pipeAsync_1["default"](catchErrorAsync_1["default"](willError))(10)];
					case 1:
						value = _a.sent();
	...
	it('should resolve to have a value property if function doesnt error', function () {
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, pipeAsync_1["default"](catchErrorAsync_1["default"](double))(10)];
					case 1:
						result = _a.sent();
	...
	it('should resolve the catch error result error in a pipeline', function () {
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, pipeAsync_1["default"](double, catchErrorAsync_1["default"](willError))(10)];
					case 1:
						result = _a.sent();
	...
	it('should resolve the catch error result value in a pipeline', function () {
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, pipeAsync_1["default"](double, catchErrorAsync_1["default"](double))(10)];
					case 1:
						result = _a.sent();
